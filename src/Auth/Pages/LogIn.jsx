    ...
    <section className="form__section">
      ...
      <div className="form__box" data-aos="fade-up" data-aos-easing="ease-out-back" data-aos-delay="100" >
        <div className="form__top">
          ...
          <div className="form__top-subtitle">Glad to see you again! Login to your account below</div>
        </div>
        ...
        <div className="form__input-box">
          ...
          <input type="email" name="email" id="email" placeholder="you@example.com" onChange={(e) => { setEmail(e.target.value) }} required />
        </div>
        <div className="form__input-box">
          <label htmlFor="password">Password</label>
          <input type="password" name="pasword" id="pasword" placeholder="enter password..." onChange={(e) => { setPassword(e.target.value) }} required />
        </div>
