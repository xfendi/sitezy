...
const Index = () => {
  ...
  return (
    <section className="auth" id="auth">
      ...
      <div className="form form__box" data-aos="fade-up" data-aos-easing="ease-out-back" data-aos-delay="100" >
        <div className="form__top">
          <div className="form__logo"><img src={LogoPrimary} alt="sitezy" width="55px" /></div>
          <div className="form__top-title">Your Company</div>
          <div className="form__top-subtitle">Join existing company or crete new one!</div>
        </div>
        <div className="form__buttons">
          <a href='/account/setup/company/join' className="btn-dark">Join</a>
          <a href='/account/setup/company/create' className="btn-primary">Create</a>
        </div>
